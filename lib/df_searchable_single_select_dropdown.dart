...
class DfSearchableSingleSelectDropdown<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => SingleSelectSearchableDropdownProvider<T>(
        initData: initData,
...
class _Dropdown<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        DropdownField<SingleSelectSearchableDropdownProvider<T>>(
          hintText: hintText,
          labelText: labelText,
          disableInput: true,
          ...
          suffixWidget: SizedBox(
            ...
            child: SvgPicture.asset(
              context
                      .watch<SingleSelectSearchableDropdownProvider<T>>()
                      .suggestionsExpanded
                  ? Icons.upIcon
                  : Icons.downIcon,
            ),
        ...
        Consumer<SingleSelectSearchableDropdownProvider<T>>(
